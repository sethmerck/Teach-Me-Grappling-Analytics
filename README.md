...
This project scrapes all videos and their information (such as title, upload date, view count) from several YouTube channels all dedicated to the same topic and analyzes if there are factors within the title (i.e. specific buzzwords or terms being mentioned w/n the title) that affect the view counts of videos.
...
**Tech used:** Python, Selenium, Pandas, Matplotlib, Microsoft Excel, MySQL
